...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/L1.png" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/L2.png" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lib1.png" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/lib2.png" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/audi.png" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/audi1.png" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. Vivek Yakkundi</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>Lokmanya Tilak College of Engineering</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. Vivek K. Sunnapawar</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> Lokmanya Tilak College of Engineering</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/vice.png" class="img-rounded"/>
                    <h3 align="center">Dr. Subhash K. Shinde</h3>
                    <hr/>
                    <h4 align="center">Vice-Principal<br/>Lokmanya Tilak College of Engineering</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Sector 4, Vikas Nagar, Koparkhairane, 
                Navi Mumbai - 400 079
                </h4>
                <h4><strong>Call:</strong>+91-022-27541005, +91-022-27541006 
                 </h4>
                <h4><strong>Email: </strong>principal.ltce@ltjss.net </h4>
            </div>
